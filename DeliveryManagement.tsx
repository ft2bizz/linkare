  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-20">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-3xl font-black text-slate-900 tracking-tight">New Project Wizard</h2>
          <p className="text-slate-500 font-medium">Follow the steps to initialize your project with AI.</p>
        </div>
        {step < 5 && (
          <button 
            onClick={() => navigate('/dashboard')}
            className="p-3 bg-white border border-slate-200 rounded-2xl text-slate-400 hover:text-red-600 hover:border-red-100 transition-all shadow-sm flex items-center gap-2 font-bold text-xs uppercase tracking-widest"
          >
            <X size={18} />
            Cancel & Close
          </button>
